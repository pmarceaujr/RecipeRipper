      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => handleChange('recipe_source', e.target.value)}
          />
        </div>
        ...
        {recipe.directions.map((dir, idx) => (
          <div key={idx} className="direction-row">
            ...
            />
            <button type="button" onClick={() => removeDirection(idx)}>❌</button>
          </div>
        ))}
        ...
        {recipe.comments.map((comment, idx) => (
          <div key={idx} className="comment-row">
            ...
            />
            <button type="button" onClick={() => removeComment(idx)}>❌</button>
          </div>
        ))}
